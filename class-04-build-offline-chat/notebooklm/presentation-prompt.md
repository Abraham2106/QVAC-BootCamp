# NotebookLM Detailed Slide Deck — Clase 4
...
**Build the Offline Chat** (The Local-First AI Systems Masterclass)
...
Fuentes: lesson Clase 4, QVAC Text Generation, API Summary, Profiler, How It Works, release notes v0.18.x.
